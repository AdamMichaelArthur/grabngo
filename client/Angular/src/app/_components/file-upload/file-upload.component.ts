...
export class FileUploadComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //this.excelFileFormat = JSON.parse(this.addDataFormStr)

    console.log(35, this.filter)
    //console.log(this.excelFileFormat[0])
    //console.log(this.fileFormat.keyword)
    console.log(38, this.validation);
  }
